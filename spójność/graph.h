...
public:
    ...
    AdjacentIterator neighbor_begin(int r) { return AdjacentIterator(this, r); }
    AdjacentIterator neighbor_end(int r) { return AdjacentIterator(this, r, this->adj_matrix.size()); }
